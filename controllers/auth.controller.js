...
class AuthController {
  ...
  static async login(req, res) {
    ...
    try {
      ...
      userTokenData['id'] = user.id;
      userTokenData['firstName'] = user.firstName;
      userTokenData['lastName'] = user.lastName;
      userTokenData['email'] = user.email;
      userTokenData['mobile'] = user.mobile;
      userTokenData['userRole'] = user.userRole;

      let token = jwt.sign({ userTokenData }, process.env.JWT_SECRET, { expiresIn: '10d' });
